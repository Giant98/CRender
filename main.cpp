...
int main()
{
	...
	unsigned char* framebuffer  = (unsigned char *)malloc(sizeof(unsigned char) * width * height * 4);//Ö¡»º³å
	memset(framebuffer, 0, sizeof(unsigned char) * width * height * 4);//unsigned char±íÊ¾·¶Î§0-255
